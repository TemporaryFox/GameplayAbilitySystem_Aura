...
public:
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_LifeRegeneration, Category = "Secondary Attributes")
	FGameplayAttributeData LifeRegeneration;
	ATTRIBUTE_ACCESSORS(UAuraAttributeSet, LifeRegeneration);
